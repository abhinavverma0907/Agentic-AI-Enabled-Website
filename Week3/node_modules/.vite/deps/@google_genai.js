...
function computerUseToVertex$2(fromObject) {
	...
	if (fromEnvironment != null) setValueByPath(toObject, ["environment"], fromEnvironment);
	const fromExcludedPredefinedFunctions = getValueByPath(fromObject, ["excludedPredefinedFunctions"]);
	if (fromExcludedPredefinedFunctions != null) setValueByPath(toObject, ["excludedPredefinedFunctions"], fromExcludedPredefinedFunctions);
	const fromEnablePromptInjectionDetection = getValueByPath(fromObject, ["enablePromptInjectionDetection"]);
	if (fromEnablePromptInjectionDetection != null) setValueByPath(toObject, ["enablePromptInjectionDetection"], fromEnablePromptInjectionDetection);
	if (getValueByPath(fromObject, ["disabledSafetyPolicies"]) !== void 0) throw new Error("disabledSafetyPolicies parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function toolToVertex$2(fromObject) {
	...
	const fromComputerUse = getValueByPath(fromObject, ["computerUse"]);
	if (fromComputerUse != null) setValueByPath(toObject, ["computerUse"], computerUseToVertex$2(fromComputerUse));
...
function audioTranscriptionConfigToMldev$1(fromObject) {
	...
	if (fromLanguageAuto != null) setValueByPath(toObject, ["languageAuto"], fromLanguageAuto);
	const fromLanguageHints = getValueByPath(fromObject, ["languageHints"]);
	if (fromLanguageHints != null) setValueByPath(toObject, ["languageHints"], fromLanguageHints);
	const fromAdaptationPhrases = getValueByPath(fromObject, ["adaptationPhrases"]);
	if (fromAdaptationPhrases != null) setValueByPath(toObject, ["adaptationPhrases"], fromAdaptationPhrases);
	return toObject;
}
...
function toolToVertex$1(fromObject) {
	...
	if (fromRetrieval != null) setValueByPath(toObject, ["retrieval"], fromRetrieval);
	const fromComputerUse = getValueByPath(fromObject, ["computerUse"]);
	if (fromComputerUse != null) setValueByPath(toObject, ["computerUse"], computerUseToVertex$1(fromComputerUse));
	if (getValueByPath(fromObject, ["fileSearch"]) !== void 0) throw new Error("fileSearch parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], fromGoogleSearch);
	const fromGoogleMaps = getValueByPath(fromObject, ["googleMaps"]);
...
function voiceActivityFromVertex(fromObject) {
	...
	if (fromAudioOffset != null) setValueByPath(toObject, ["audioOffset"], fromAudioOffset);
	return toObject;
}
/**
* @license
...
function toolToVertex(fromObject, rootObject) {
	...
	if (fromRetrieval != null) setValueByPath(toObject, ["retrieval"], fromRetrieval);
	const fromComputerUse = getValueByPath(fromObject, ["computerUse"]);
	if (fromComputerUse != null) setValueByPath(toObject, ["computerUse"], computerUseToVertex(fromComputerUse));
	if (getValueByPath(fromObject, ["fileSearch"]) !== void 0) throw new Error("fileSearch parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], fromGoogleSearch);
	const fromGoogleMaps = getValueByPath(fromObject, ["googleMaps"]);
...
var LIBRARY_LABEL = `google-genai-sdk/2.10.0`;
						...
						for (var _f = true, response_1 = (e_1 = void 0, __asyncValues(response)), response_1_1; response_1_1 = yield __await(response_1.next()), _a = response_1_1.done, !_a; _f = true) {
							...
							if (chunk.candidates && ((_d = chunk.candidates[0]) === null || _d === void 0 ? void 0 : _d.content)) {
								...
								for (const part of (_e = chunk.candidates[0].content.parts) !== null && _e !== void 0 ? _e : []) if (remoteCallCount < maxRemoteCalls && part.functionCall) {
									...
									if (!afcTools.has(part.functionCall.name)) throw new Error(`Automatic function calling was requested, but not all the tools the model used implement the CallableTool interface. Available tools: ${afcTools.keys()}, missing tool: ${part.functionCall.name}`);
									else {
...
function env() {
	...
	let envObject = {};
	if (isDeno()) envObject = (_d = (_c = (_b = (_a = globals.Deno) === null || _a === void 0 ? void 0 : _a.env) === null || _b === void 0 ? void 0 : _b.toObject) === null || _c === void 0 ? void 0 : _c.call(_b)) !== null && _d !== void 0 ? _d : {};
	else envObject = (_f = (_e = globals.process) === null || _e === void 0 ? void 0 : _e.env) !== null && _f !== void 0 ? _f : {};
	envMemo = envObject;
	return envMemo;
}
/**
...
function fillGlobals(options) {
	...
	const envVars = env();
	if (typeof envVars.GOOGLE_GENAI_API_VERSION !== "undefined") (_a = clone.api_version) !== null && _a !== void 0 || (clone.api_version = envVars.GOOGLE_GENAI_API_VERSION);
	if (typeof envVars.GOOGLE_GENAI_API_REVISION !== "undefined") (_b = clone.api_revision) !== null && _b !== void 0 || (clone.api_revision = envVars.GOOGLE_GENAI_API_REVISION);
	if (typeof envVars.GOOGLE_GENAI_USER_PROJECT !== "undefined") (_c = clone.user_project) !== null && _c !== void 0 || (clone.user_project = envVars.GOOGLE_GENAI_USER_PROJECT);
	return clone;
}
/**
* @license
...
var GoogleGenAIAuthHook = class {
	...
	async beforeRequest(hookCtx, request) {
		...
		if (hasAuthHeaders(request.headers)) return request;
...
function decodeSDKLevelAPIVersionPath(url) {
	...
	if (!decodedAPIVersion.includes("/")) return url;
	const nextURL = new URL(url);
	nextURL.pathname = `/${decodedAPIVersion}/${rest.join("/")}`;
	return nextURL;
}
async function resolveSecurity$1(securitySource, requestURL) {
	if (isSecurityResolver(securitySource)) return securitySource.resolveGoogleGenAISecurity(requestURL);
	const security = typeof securitySource === "function" ? await securitySource() : securitySource;
	if (isSecurity(security)) return withEnvSecurity(security);
	return withEnvSecurity(void 0);
}
function getStaticDefaultHeaders(securitySource) {
	var _a, _b;
	if (isSecurityResolver(securitySource)) return (_b = (_a = securitySource.getDefaultHeaders) === null || _a === void 0 ? void 0 : _a.call(securitySource)) !== null && _b !== void 0 ? _b : securitySource.defaultHeaders;
	if (isSecurity(securitySource)) return securitySource.default_headers;
}
function withEnvSecurity(security) {
	var _a, _b;
	const envVars = env();
	const nextSecurity = Object.assign(Object.assign({}, security), {
		api_key: (_a = security === null || security === void 0 ? void 0 : security.api_key) !== null && _a !== void 0 ? _a : envVars.GOOGLE_GENAI_API_KEY,
		access_token: (_b = security === null || security === void 0 ? void 0 : security.access_token) !== null && _b !== void 0 ? _b : envVars.GOOGLE_GENAI_ACCESS_TOKEN
	});
...
function securityFromHeaders(headers) {
	...
	for (const [key, value] of headers) {
		...
		if (lowerKey !== "authorization" && lowerKey !== "x-goog-api-key") defaultHeaders[key] = value;
	}
	const security = {
		access_token: (_a = headers.get("authorization")) !== null && _a !== void 0 ? _a : void 0,
...
function applyDefaultHeaders(target, source) {
	if (!source) return;
	for (const [key, value] of new Headers(source)) if (target.get(key) === null) target.set(key, value);
}
function applyApiRevision(hookCtx, headers) {
	var _a;
	if (headers.get("api-revision") === null) headers.set("Api-Revision", (_a = hookCtx.options.api_revision) !== null && _a !== void 0 ? _a : GOOGLE_GENAI_API_REVISION);
}
function applyUserProject(hookCtx, headers) {
	if (hookCtx.options.user_project !== void 0 && headers.get("x-goog-user-project") === null) headers.set("x-goog-user-project", hookCtx.options.user_project);
}
function applyAuth(headers, security) {
	...
	if (security.access_token) headers.set("Authorization", bearer(security.access_token));
}
...
var HTTPClientError = class extends Error {
	constructor(message, opts) {
		let msg = message;
		if (opts === null || opts === void 0 ? void 0 : opts.cause) msg += `: ${opts.cause}`;
		super(msg, opts);
		this.name = "HTTPClientError";
		if (typeof this.cause === "undefined") this.cause = opts === null || opts === void 0 ? void 0 : opts.cause;
	}
};
/**
...
var APIError = class APIError extends GeminiNextGenAPIClientError {
	...
	static generate(status, errorResponse, message, headers) {
		...
		if (status >= 500) return new InternalServerError(status, errorResponse, message, headers);
...
var APIConnectionTimeoutError = class extends APIConnectionError {
	constructor({ message } = {}) {
		super({ message: message || "Request timed out. This is a client-side timeout. You can increase the timeout by setting the `timeout` argument in your request or client http options." });
	}
};
...
function wrapSDKError(error) {
	if (isCompatAPIErrorInstance(error)) return error;
	if (error instanceof GoogleGenAiError) return wrapAPIError(error);
	if (error instanceof HTTPClientError) return wrapHTTPClientError(error);
	return error;
}
...
function wrapHTTPClientError(error) {
	if (error instanceof RequestTimeoutError) return new APIConnectionTimeoutError({ message: error.message });
	if (error instanceof RequestAbortedError) return new APIUserAbortError({ message: error.message });
	if (error instanceof ConnectionError) return new APIConnectionError({
...
var SDKHooks = class {
	constructor() {
		...
		for (const hook of []) {
			if ("sdkInit" in hook) this.registerSDKInitHook(hook);
			if ("beforeCreateRequest" in hook) this.registerBeforeCreateRequestHook(hook);
			if ("beforeRequest" in hook) this.registerBeforeRequestHook(hook);
			if ("afterSuccess" in hook) this.registerAfterSuccessHook(hook);
			if ("afterError" in hook) this.registerAfterErrorHook(hook);
		}
		initHooks(this);
	}
	...
	async beforeRequest(hookCtx, request) {
		let req = request;
		for (const hook of this.beforeRequestHooks) req = await hook.beforeRequest(hookCtx, req);
		return req;
	}
	async afterSuccess(hookCtx, response) {
		let res = response;
		for (const hook of this.afterSuccessHooks) res = await hook.afterSuccess(hookCtx, res);
		return res;
	}
...
*/
var ServerList = ["https://generativelanguage.googleapis.com"];
...
var SDK_METADATA = { userAgent: "speakeasy-sdk/typescript 2.4.1-preview.4 2.911.0 v1beta @google/genai" };
/**
* @license
* Copyright 2026 Google LLC
* SPDX-License-Identifier: Apache-2.0
...
function combineSignals(...signals) {
	const filtered = [];
	for (const signal of signals) if (signal) filtered.push(signal);
	switch (filtered.length) {
		case 0:
		case 1: return filtered[0] || null;
		default:
			if ("any" in AbortSignal && typeof AbortSignal.any === "function") return AbortSignal.any(filtered);
...
function abortSignalAny(signals) {
	...
	if (signals.length === 1) return signals[0] || controller.signal;
...
function formEncoder(sep) {
	return (key, value, options) => {
		...
		pairs.forEach(([pk, pv]) => {
			...
			let encValue = null;
			if (pv == null) return;
			else if (Array.isArray(pv)) encValue = (_a = mapDefined(pv, (v) => `${encodeValue(v)}`)) === null || _a === void 0 ? void 0 : _a.join(encodedSep);
			else if (isPlainObject$1(pv)) encValue = (_b = mapDefinedEntries(Object.entries(pv), ([k, v]) => {
...
var encodeSimple = (key, value, options) => {
	...
	pairs.forEach(([pk, pv]) => {
		...
		let tmp = "";
		if (pv == null) return;
		else if (Array.isArray(pv)) tmp = (_a = mapDefined(pv, (v) => `${encodeValue(v)}`)) === null || _a === void 0 ? void 0 : _a.join(",");
		...
		} else tmp = `${(options === null || options === void 0 ? void 0 : options.explode) && isPlainObject$1(value) ? `${pk}=` : ""}${encodeValue(pv)}`;
		out += tmp ? `,${tmp}` : "";
	});
	return out.slice(1);
};
function explode(key, value) {
	...
	else if (isPlainObject$1(value)) return Object.entries(value !== null && value !== void 0 ? value : {}).map(([k, v]) => [k, v]);
...
var HTTPClient = class HTTPClient {
	...
	addHook(...args) {
		if (args[0] === "beforeRequest") this.requestHooks.push(args[1]);
		else if (args[0] === "requestError") this.requestErrorHooks.push(args[1]);
		else if (args[0] === "response") this.responseHooks.push(args[1]);
		else throw new Error(`Invalid hook type: ${args[0]}`);
		return this;
	}
	removeHook(...args) {
		let target;
		if (args[0] === "beforeRequest") target = this.requestHooks;
		else if (args[0] === "requestError") target = this.requestErrorHooks;
		else if (args[0] === "response") target = this.responseHooks;
		else throw new Error(`Invalid hook type: ${args[0]}`);
...
var codeRangeRE$1 = /* @__PURE__ */ new RegExp("^[0-9]xx$", "i");
...
var PermanentError = class PermanentError extends Error {
	constructor(message, options) {
		let msg = message;
		if (options === null || options === void 0 ? void 0 : options.cause) msg += `: ${options.cause}`;
		super(msg, options);
		this.name = "PermanentError";
		if (typeof this.cause === "undefined") this.cause = options === null || options === void 0 ? void 0 : options.cause;
...
async function retry(fetchFn, options) {
	...
	switch (options.config.strategy) {
		...
		case "attempt-count-backoff": return retryAttemptCountBackoff(wrapFetcher(fetchFn, {
			statusCodes: options.statusCodes,
			retryConnectionErrors: !!options.config.retryConnectionErrors
		}), Object.assign(Object.assign({}, defaultBackoff), options.config.backoff), options.config);
		default: return await fetchFn(0);
	}
}
...
var codeRangeRE = /* @__PURE__ */ new RegExp("^[0-9]xx$", "i");
...
async function retryAttemptCountBackoff(fn, strategy, config) {
	...
	while (true) try {
		...
		let retryInterval = 0;
		if (err instanceof TemporaryError) retryInterval = retryIntervalFromResponse(err.response);
		if (retryInterval <= 0) retryInterval = strategy.initialInterval * Math.pow(strategy.exponent, attempt) * (1 - Math.random() * .25);
		await delay(Math.min(retryInterval, strategy.maxInterval));
		attempt++;
	}
}
...
var isBrowserLike = typeof gt === "object" && gt != null && "importScripts" in gt && typeof gt["importScripts"] === "function" || typeof navigator !== "undefined" && "serviceWorker" in navigator || typeof window === "object" && typeof window.document !== "undefined";
var ClientSDK = class {
	constructor(options = {}) {
		const opt = options;
		if (typeof opt === "object" && opt != null && "hooks" in opt && opt.hooks instanceof SDKHooks) this._hooks = opt.hooks;
		else this._hooks = new SDKHooks();
		const defaultHttpClient = new HTTPClient();
		options.http_client = options.http_client || defaultHttpClient;
		options = this._hooks.sdkInit(options);
		const url = serverURLFromOptions(options);
		if (url) url.pathname = url.pathname.replace(/\/+$/, "") + "/";
		this._baseURL = url;
		...
		if (!this._logger && env().GOOGLE_GENAI_DEBUG) this._logger = console;
	}
	_createRequest(context, conf, options) {
		var _a, _b, _c, _d, _e;
		const { method, path, query, headers: opHeaders, security } = conf;
		const base = (_a = conf.baseURL) !== null && _a !== void 0 ? _a : this._baseURL;
		if (!base) return ERR(new InvalidRequestError("No base URL provided for operation"));
		...
		const mergeQuery = (current, additions) => {
			...
			const additionKeys = new Set(additions.split("&").filter((pair) => pair !== "").map((pair) => {
				var _a;
				return (_a = pair.split("=")[0]) !== null && _a !== void 0 ? _a : "";
			}));
			return [...current.split("&").filter((pair) => {
				var _a;
		...
		for (const [k, v] of securityHeaders) headers.set(k, v);
		let cookie = headers.get("cookie") || "";
		for (const [k, v] of Object.entries((security === null || security === void 0 ? void 0 : security.cookies) || {})) cookie += `; ${k}=${v}`;
		...
		if (!isBrowserLike) headers.set((_d = conf.uaHeader) !== null && _d !== void 0 ? _d : "user-agent", (_e = conf.userAgent) !== null && _e !== void 0 ? _e : SDK_METADATA.userAgent);
		...
		if (Object.keys(extraBody).length > 0) {
			...
			if (!/^(application|text)\/([^+]+\+)*json/.test(contentType) || typeof reqBody !== "string" && reqBody != null) return ERR(new InvalidRequestError("extra_body can only be merged into JSON object request bodies"));
			let parsedBody;
			try {
			...
			if (!isPlainObject$1(parsedBody)) return ERR(new InvalidRequestError("extra_body can only be merged into JSON object request bodies"));
		...
		if (!(fetchOptions === null || fetchOptions === void 0 ? void 0 : fetchOptions.signal) && conf.timeout_ms != null && conf.timeout_ms > 0) context.timeout_ms = conf.timeout_ms;
		if (conf.body instanceof ReadableStream) Object.assign(fetchOptions, { duplex: "half" });
		let input;
		try {
			...
			return ERR(new UnexpectedClientError("Create request hook failed to execute", { cause: err }));
		}
	...
	async _do(request, options) {
		...
		return retry(async () => {
			...
			await logRequest(this._logger, req).catch((e) => {
				var _a;
				return (_a = this._logger) === null || _a === void 0 ? void 0 : _a.log("Failed to log request:", e);
			});
			...
			try {
				...
				} else response = await this._hooks.afterSuccess(context, response);
			} finally {
				await logResponse(this._logger, response, req).catch((e) => {
					var _a;
					return (_a = this._logger) === null || _a === void 0 ? void 0 : _a.log("Failed to log response:", e);
				});
			}
			return response;
		}, {
			...
			switch (true) {
				case isAbortError(err): return ERR(new RequestAbortedError("Request aborted by client", { cause: err }));
				case isTimeoutError(err): return ERR(new RequestTimeoutError("Request timed out", { cause: err }));
				case isConnectionError(err): return ERR(new ConnectionError("Unable to make request", { cause: err }));
				default: return ERR(new UnexpectedClientError("Unexpected HTTP client error", { cause: err }));
			}
		});
	}
};
...
var GoogleGenAiDefaultError = class extends GoogleGenAiError {
	constructor(message, httpMeta) {
		...
		if (contentType !== "application/json") message += ` Content-Type ${contentType.includes(" ") ? `"${contentType}"` : contentType}`;
		const body = httpMeta.body || `""`;
		message += body.length > 100 ? "\n" : ". ";
		let bodyDisplay = body;
		if (body.length > 1e4) bodyDisplay = `${body.substring(0, 1e4)}...and ${body.length - 1e4} more chars`;
...
function wrapEventStreamResponse(body, opts = {}) {
	...
	return new Stream(body, (rawEvent) => {
		if (sentinel !== "" && rawEvent.data === sentinel) return {
			done: true,
			value: void 0
		};
		if (flattened) return {
			done: false,
			value: rawEvent.data == null ? void 0 : tryParseJson(rawEvent.data)
		};
		return {
			done: false,
...
var Stream = class extends ReadableStream {
	constructor(responseBody, parse, opts) {
		...
		let buffer = /* @__PURE__ */ new Uint8Array(4096);
		let bufferLen = 0;
		let searchStart = 0;
	...
	[Symbol.asyncIterator](options) {
		...
		if (asyncDispose) iterator[asyncDispose] = async () => {
			var _a;
...
function findBoundary(buf, len, from) {
	for (let i = from; i < len; i++) {
		...
		for (const boundary of BOUNDARIES) {
			...
			let match = true;
			for (let j = 0; j < boundary.length; j++) if (buf[i + j] !== boundary[j]) {
				match = false;
				break;
			}
			if (match) return {
...
function parseMessage(chunk, parse, state, dataRequired) {
	...
	for (const line of lines) {
		...
		else if (field === "retry" && /^\d+$/.test(value)) ret.retry = Number(value);
	}
	if (ignore) return;
	...
	return async function matchFunc(response, request, options) {
		...
		switch (encoding) {
			...
			case "fail":
				...
				raw = body;
				break;
			default: throw new Error(`Unsupported response type: ${encoding}`);
		}
		if (matcher.enc === "fail") return [{
			ok: false,
		...
		if ("err" in matcher) data = Object.assign(Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.extraFields), headersField), isPlainObject$1(raw) ? raw : null);
		else if (resultKey) data = Object.assign(Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.extraFields), headersField), { [resultKey]: raw });
		else if (matcher.hdrs) data = Object.assign(Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.extraFields), headersField), isPlainObject$1(raw) ? raw : null);
		else data = raw;
		if ("err" in matcher) return [{
			ok: false,
			error: matcher.errorClass ? new matcher.errorClass(data, {
				request,
				response,
				body
			}) : data
...
function unpackHeaders(headers) {
	const out = {};
	for (const [k, v] of headers.entries()) out[k] = v.split(headerValRE);
	return out;
}
/**
* @license
...
*/
var _a;
var APIPromise = class APIPromise {
	...
	asResponse() {
		var _b;
		return ((_b = this._callSource) !== null && _b !== void 0 ? _b : this._callSource = this._promise.then(([, call]) => call)).then((call) => {
			if (!call.response) throw new Error("APIPromise.asResponse: response unavailable");
...
function unwrapAsAPIPromise(p) {
	...
	const callSource = inner.then(([r, call]) => {
		var _b;
		if (!r.ok && !((_b = call.response) === null || _b === void 0 ? void 0 : _b.ok)) throw r.error;
		return call;
	});
	data.catch(() => {});
	callSource.catch(() => {});
...
async function $do$e(client, body, api_version, options) {
	...
	const pathParams = { api_version: encodeSimple("api_version", (_a = payload.api_version) !== null && _a !== void 0 ? _a : client._options.api_version, {
		explode: false,
		charEncoding: "percent"
	}) };
	...
	const requestSecurity = resolveGlobalSecurity(await extractSecurity(client._options.security));
	const context = {
	...
	if (!requestRes.ok) return [requestRes, { status: "invalid" }];
...
async function $do$d(client, id, api_version, options) {
	...
	const body = null;
	const pathParams = {
		api_version: encodeSimple("api_version", (_a = payload.api_version) !== null && _a !== void 0 ? _a : client._options.api_version, {
			explode: false,
			charEncoding: "percent"
		}),
	...
	const headers = new Headers(compactMap({ Accept: "application/json" }));
	const requestSecurity = resolveGlobalSecurity(await extractSecurity(client._options.security));
	const context = {
		options: client._options,
		base_url: (_c = (_b = options === null || options === void 0 ? void 0 : options.server_url) !== null && _b !== void 0 ? _b : client._baseURL) !== null && _c !== void 0 ? _c : "",
...
async function $do$b(client, api_version, page_size, page_token, parent, options) {
	...
	const body = null;
	const pathParams = { api_version: encodeSimple("api_version", (_a = payload === null || payload === void 0 ? void 0 : payload.api_version) !== null && _a !== void 0 ? _a : client._options.api_version, {
		explode: false,
		charEncoding: "percent"
	}) };
	const path = pathToFunc("/{api_version}/agents")(pathParams);
...
var CancelInteractionByIdServerError = class extends GoogleGenAiError {
	constructor(err, httpMeta) {
		var _a;
		const message = ((_a = err.error) === null || _a === void 0 ? void 0 : _a.message) || `API error occurred: ${JSON.stringify(err)}`;
		super(message, httpMeta);
		this.data$ = err;
...
async function $do$7(client, id, stream, last_event_id, include_input, api_version, options) {
	...
	const headers = new Headers(compactMap({ Accept: (input === null || input === void 0 ? void 0 : input.stream) ? "text/event-stream" : "application/json" }));
	const requestSecurity = resolveGlobalSecurity(await extractSecurity(client._options.security));
	const context = {
		options: client._options,
		base_url: (_c = (_b = options === null || options === void 0 ? void 0 : options.server_url) !== null && _b !== void 0 ? _b : client._baseURL) !== null && _c !== void 0 ? _c : "",
...
async function $do(client, id, api_version, update_mask, body, options) {
	...
	const path = pathToFunc("/{api_version}/webhooks/{id}")(pathParams);
	const query = encodeFormQuery({ "update_mask": payload.update_mask });
	const headers = new Headers(compactMap({
		"Content-Type": "application/json",
		Accept: "application/json"
	}));
...
* g3-prettier-ignore-file
*/
var LEGACY_LYRIA_MODELS = /* @__PURE__ */ new Set(["lyria-3-pro-preview", "lyria-3-clip-preview"]);
function getGoogleGenAIServerURL(parentClient) {
	const serverURL = parentClient.getBaseUrl();
	if (!serverURL) throw new Error("Base URL must be set.");
...
function getGoogleGenAIAPIVersion(parentClient) {
	...
	if (parentClient.isVertexAI() && apiVersion && project && location) return `${apiVersion}/projects/${encodeURIComponent(project)}/locations/${encodeURIComponent(location)}`;
	return apiVersion;
}
function buildGoogleGenAIClient(parentClient, options = {}) {
	var _a, _b, _c, _d;
	return new GoogleGenAI$1(Object.assign(Object.assign({}, options), {
		api_version: (_a = options.api_version) !== null && _a !== void 0 ? _a : getGoogleGenAIAPIVersion(parentClient),
...
var GeminiNextGenInteractions = class {
	...
	async create(params, options) {
		...
		if (request.stream === true) return wrapStreamErrors(await wrapSDKCall(() => this.getClient(api_version).interactions.create(Object.assign(Object.assign({}, request), {
			stream: true,
			api_version
		}), toGoogleGenAIRequestOptions(options, true))));
		return addOutputPropertiesIfInteraction(await unwrapWithSdkHttpResponse(interactionsCreate(this.getClient(api_version), request, api_version, toGoogleGenAIRequestOptions(options))));
	}
	async get(id, params = {}, options) {
		const { api_version, stream = false, last_event_id, include_input } = params !== null && params !== void 0 ? params : {};
		if (stream === true) return wrapStreamErrors(await wrapSDKCall(() => this.getClient(api_version).interactions.get(id, {
			stream,
			last_event_id,
			include_input,
			api_version
		}, toGoogleGenAIRequestOptions(options, true))));
		return addOutputPropertiesIfInteraction(await unwrapWithSdkHttpResponse(interactionsGet(this.getClient(api_version), id, stream, last_event_id, include_input, api_version, toGoogleGenAIRequestOptions(options))));
	}
	...
	getClient(apiVersion) {
		var _a;
		if (apiVersion) return buildGoogleGenAIClient(this.parentClient, { api_version: apiVersion });
		(_a = this.sdk) !== null && _a !== void 0 || (this.sdk = buildGoogleGenAIClient(this.parentClient));
		return this.sdk;
	}
};
...
function toGoogleGenAIRequestOptions(options, streaming = false) {
	...
	const _e = options !== null && options !== void 0 ? options : {}, { timeout, maxRetries, defaultBaseURL, query, body, fetchOptions } = _e, rest = __rest(_e, [
		"timeout",
		"maxRetries",
		"defaultBaseURL",
		"query",
	...
	if (isPlainObject(query)) nextOptions.extra_query = query;
	else warnIgnoredOption("query", query);
	if (isPlainObject(body)) nextOptions.extra_body = body;
	else warnIgnoredOption("body", body);
	const fetch_options = (_a = rest.fetch_options) !== null && _a !== void 0 ? _a : fetchOptions;
	if (fetch_options) nextOptions.fetch_options = fetch_options;
	const server_url = (_b = rest.server_url) !== null && _b !== void 0 ? _b : defaultBaseURL;
	if (server_url) nextOptions.server_url = server_url;
	const timeout_ms = (_c = rest.timeout_ms) !== null && _c !== void 0 ? _c : timeout;
	if (timeout_ms !== void 0) nextOptions.timeout_ms = timeout_ms;
	if (maxRetries !== void 0) nextOptions.retries = {
		strategy: "attempt-count-backoff",
		retryConnectionErrors: true,
		maxRetries
	};
...
function warnIgnoredOption(name, value) {
	if (value !== void 0 && value !== null) console.warn(`GoogleGenAI.interactions: request option ${name} is not supported by the Google GenAI interactions bridge and will be ignored.`);
}
async function unwrapWithSdkHttpResponse(promise) {
	const [result, call] = await promise.$inspect();
	if (!result.ok) throw wrapSDKError(result.error);
	...
	return new Proxy(stream, { get(target, property) {
		...
		return function wrappedAsyncIterator() {
			...
			return {
				...
				async throw(error) {
					if (!iterator.throw) throw wrapSDKError(error);
					try {
...
function attachSdkHttpResponse(value, call) {
	if (!isPlainObject(value) || call.status !== "complete") return value;
...
function addOutputProperties(interaction) {
	...
	for (let i = steps.length - 1; i >= 0; i--) {
		const step = steps[i];
		if (step.type === "user_input") break;
		if (step.type === "model_output" && step.content) for (let j = step.content.length - 1; j >= 0; j--) {
...
var GoogleGenAI = class {
	getNextGenClient() {
		...
		if (this._nextGenClient === void 0) this._nextGenClient = buildGoogleGenAIClient(this.apiClient, { timeout_ms: httpOpts === null || httpOpts === void 0 ? void 0 : httpOpts.timeout });
		if (httpOpts === null || httpOpts === void 0 ? void 0 : httpOpts.extraBody) console.warn("GoogleGenAI: Client level httpOptions.extraBody is not supported by the Gemini NextGen client and will be ignored.");
